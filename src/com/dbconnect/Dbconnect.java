	...
	public Statement dbconnect() throws ClassNotFoundException, SQLException 
	 {   
		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		      con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=BBC_PROD3;selectMethod=cursor","sa", "sa@123");
		//con =DriverManager.getConnection("jdbc:sqlserver://75.99.49.198:1433;databaseName=BBC_PROD;selectMethod=cursor","bicyclebuys","bicyclebuys" );
